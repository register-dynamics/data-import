...
exports.supportedTypes = new Map([
  ["text", {niceName: "Text", description: "Any text"}],
  ["number", {niceName: "Number", description: "A (real) number, possibly including negative numbers and decimals"}],
  ["boolean", {niceName: "Y/N", description: "A 'Yes' or 'No'"}],
  ["date", {niceName: "Date", description: "A full date (eg Year, Month and Day number)",
            formats: new Map([
              ["native", {niceName: "Spreadsheet", description: "A date cell in a spreadsheet"}],
              ["ymd", {niceName: "Y/M/D", description: "A date written in Year, Month, Day order"}],
              ["ydm", {niceName: "Y/D/M", description: "A date written in Year, Day, Month order"}],
              ["dmy", {niceName: "D/M/Y", description: "A date written in Day, Month, Year order"}],
              ["mdy", {niceName: "M/D/Y", description: "A date written in Month, Day, Year order"}]
            ])}]
]);
