...
describe("Backend tests", () => {
  ...
  test('suggest data range', () => {
    ...
    for (let [filename, sheetname] of fixtures) {
      ...
      expect(defaultDataRange).toMatchObject(new Range(
        sheetname,
        { row: 1, column: 0 },
        { row: 6, column: 6 }
      ));
      ...
      expect(headerBasedDataRange).toMatchObject(new Range(
        sheetname,
        { row: 3, column: 0 },
        { row: 6, column: 2 }
      ));
      ...
      expect(headerAndFooterBasedDataRange).toMatchObject(new Range(
        sheetname,
        { row: 3, column: 0 },
        { row: 5, column: 2 }
      ));
