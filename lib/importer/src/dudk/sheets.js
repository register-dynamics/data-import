...
exports.MapData = (sid, mapping, fields, previewLimit = DEFAULT_PREVIEW_LIMIT) => {

  const hRange = backend.SessionGetHeaderRange(sid)
  const fRange = backend.SessionGetFooterRange(sid)
