  ...
  router.post(
    ...
    (request, response) => {
      ...
      if (request.body.table == "no_table") {
        ...
        footerRange = {
          start: { row: 11, column: footerRange.start.column },
          end: { row: 11, column: footerRange.end.column } //need to set this as default, so footer is rome immediately after table end when selecting againsty last 10 rows
        }
