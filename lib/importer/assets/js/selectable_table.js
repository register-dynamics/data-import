    ...
    for (var table of tables) {
      {
        ...
        console.log("ABS DEBUG find selectables", table, selectables);
        selectables[0].setAttribute("tabindex", 0); // First one is tabbable, to get the user into the table
        console.log("ABS DEBUG initial set tabindex of ", selectables[0].textContent);
      }
      ...
      const changeSelection = function(startCell, endCell) {
        ...
        console.log("ABS DEBUG changeSelection", startCell, endCell);
      ...
      const applySelection = function(newSelection) {
        ...
        for (var cell of oldSelectables) {
          console.log("ABS DEBUG remove tabindex of ", cell.textContent);
        ...
        console.log("ABS DEBUG focus and set tabindex of ", selection.focus.node.textContent);
      ...
      var tableFocusIn = function(event) {
        console.log("ABS DEBUG tableFocusIn", event);
        ...
        if(tableSelectables[0]) {
          ...
          if(selection == NilSelection) {
            ...
            console.log("ABS DEBUG new selection from focus", selection);
